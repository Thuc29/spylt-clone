...
function FooterSection() {
     ...
     return (
          <footer className='footer-section'>
               ...
               <div className="wxl:h-[110dvh] relative md:pt-[20vh] pt-[10vh]">
                    ...
                    </div>
                    {
                         isMobile ? (
                              ...
                              <video src="/videos/splash.mp4" muted playsInline autoPlay className='absolute top-0 object-contain mix-blend-lighten' />
                         )
                    }
